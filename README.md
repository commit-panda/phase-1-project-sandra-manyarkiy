...
**WeatherApp** is a weather forecasting application that provides the current weather conditions and the forecast for the next five days. It also suggests activities based on the weather conditions for a selected day.

---

## 🌦️ Features

- **Current Weather**: Displays the current weather (temperature, humidity, wind speed, etc.).
- **Five-Day Forecast**: Shows a 5-day weather forecast with key details.
- **Activity Suggestions**: Click on any day's forecast to see recommended activities based on the weather (e.g., "Go for a walk" for clear skies, "Stay indoors" for rain).
